                        ...
                        <div class="col-xl-4">
                            <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="oliver kopyov">
                                ...
                                <span class="status status-<?php echo $item['status']; ?> mr-3">
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('img/demo/avatars/<?php echo $item['image']; ?>'); background-size: cover;"></span>
                                </span>
                                        <div class="info-card-text flex-1">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a href="delete.php?id=<?php echo $item['id']; ?>" class="dropdown-item" onclick="return confirm('are you sure?');">
                                ...
                                <div class="card-body p-0 collapse show">
                                    <div class="p-3">
                                        <a href="tel:<?php echo $item['tel'] ?>" class="mt-1 d-block fs-sm fw-400 text-dark">
                                            <i class="fas fa-mobile-alt text-muted mr-2"></i> <?php echo $item['tel'] ?></a>
                                        ...
                                        <div class="d-flex flex-row">
                                            <a href="<?php echo $item['vk']; ?>" class="mr-2 fs-xxl" style="color:#4680C2">
                                                <i class="fab fa-vk"></i>
                                            </a>
                                            <a href="<?php echo $item['telegram']; ?>" class="mr-2 fs-xxl" style="color:#38A1F3">
                                                <i class="fab fa-telegram"></i>
                                            </a>
                                            <a href="<?php echo $item['instagram']; ?>" class="mr-2 fs-xxl" style="color:#E1306C">
